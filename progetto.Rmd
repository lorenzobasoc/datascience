...
bestRatedRestaurantsChart = bestRatedRestaurants %>% 
                              ...
                              scale_fill_gradient(low = "white", high = "red",
                                                  name = "Average Price") +
                              labs(title = "The Most Popular IzakayaS in Kyoto",
                                   y = "Rating Score") + 
...
realBestIzakayas = data.frame(Name = bestRatedRestaurants$Name, 
                              Rating = bestRatedRestaurants$TotalRating, 
                              NumReviews = bestRatedRestaurants$ReviewNum, 
                              Score = (bestRatedRestaurants$TotalRating/bestRatedRestaurants$ReviewNum) ) %>%
                  arrange(Score)
